...
public class AuthController {
    ...
    private static final String AUTH0_TOKEN_URL = "https://saml-example.us.auth0.com/oauth/token";
    ...
    public void callback(HttpServletRequest request, HttpServletResponse response) throws IOException, IdentityVerificationException {
        ...
        System.out.println("JWT Token is :"+jwt.getToken().toString());
...
//        response.sendRedirect(config.getContextPath(request) + "/");
    ...
    public String getManagementApiToken() {
        ...
        requestBody.put("audience", "https://saml-example.us.auth0.com/api/v2/");
